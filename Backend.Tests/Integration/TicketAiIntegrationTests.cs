...
//         // Act (Simulate AI Pipeline Execution)
...
//         Assert.NotNull(updatedTicket.Embedding);
//     }
// }
...
//                     // 🔥 FIX: Apna asali database connection yahan add karein!
//                     // Note: 'YOUR_PASSWORD' aur 'YOUR_DB_NAME' ko apne actual credentials se replace karein
//                     { "ConnectionStrings:DefaultConnection", "Host=localhost;Database=SupportPulse_db;Username=postgres;Password=Abhi@2080" }
//                 });
//             });
//         });
//     }
...
//                     // Added Port=5433 to match your appsettings.Development.json
...
//                     // Added Redis fallback just in case
